...
public class PerformanceAspects {
    @Around("execution(public * tn.esprit.tic.AZIZ.Services.*.add*(..))") //naaref li ay add bech trajaa objet wel pjp tnajamch tekhdem b void khater les classes taa service mahomch void lkol
